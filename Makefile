# NOTE: rebar3 is the primary build path for beamai_render (see designs/05-rebar3-plugin.md).
#
#   rebar3 compile
#   rebar3 ct
#   rebar3 dialyzer
...
# beamai_render has no dependencies by design (decision D5, see designs/02-architecture.md).
DEPS =
