...
#
#   - beamai_render and rebar3_beamai_render must be wired in through _checkouts, because
...
#     src/ and include/ -- the same thing rebar3_beamai_render_SUITE does for its
...
seed "$ROOT" "$APP/_checkouts/beamai_render"
seed "$ROOT/rebar3_beamai_render" "$APP/_checkouts/rebar3_beamai_render"
