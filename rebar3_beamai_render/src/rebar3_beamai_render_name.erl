...
%%% set difference, never on reverse derivation (see rebar3_beamai_render_gc).
%%% @end
%%%-------------------------------------------------------------------
-module(rebar3_beamai_render_name).
...
%% because beamai_mustache_ast:module_name/2 does not fold it either and a
