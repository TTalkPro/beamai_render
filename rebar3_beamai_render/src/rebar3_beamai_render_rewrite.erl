...
%%% @end
%%%-------------------------------------------------------------------
-module(rebar3_beamai_render_rewrite).

%% Deliberately no -include("beamai_mustache.hrl"): this module is part of the
...
%%
%% Mirrors beamai_mustache_scanner's delimiter handling, including `{{{x}}}' only
...
%% kept in step with beamai_mustache.hrl, and would still miss the characters
...
%% beamai_mustache_scanner:marker_of/2 applies, and it covers extension markers for
%% free.
marker_of(Inner) ->
