%%%-------------------------------------------------------------------
%%% @doc HTML escaping and value formatting, shared by every beamai_render engine.
%%%
...
to_binary(V) -> to_binary(V, beamai_html).
