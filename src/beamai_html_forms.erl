%%%-------------------------------------------------------------------
%%% @doc Erlang abstract forms constructors, shared by every beamai_render engine.
%%%
...
%%% section 1), and it may not reference any beamai_mustache_* or beamai_jinja_*
