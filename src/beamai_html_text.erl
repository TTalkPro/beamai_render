%%%-------------------------------------------------------------------
%%% @doc The canonical text representation, shared by every beamai_render engine.
%%%
%%% Template bodies and every path beamai_render handles are UTF-8 binaries. Nothing
