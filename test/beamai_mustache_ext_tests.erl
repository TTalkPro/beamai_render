%%%-------------------------------------------------------------------
%%% @doc Tests for the beamai_render-specific semantics the official spec does not
...
%%% @end
%%%-------------------------------------------------------------------
-module(beamai_mustache_ext_tests).
...
%%%===================================================================
%%% Behaviour -- generated once beamai_mustache exists
%%%===================================================================

extensions_test_() ->
    case beamai_mustache_test_lib:implemented() of
        false ->
            {"beamai_render extension semantics: PENDING -- beamai_mustache:render_string/3 "
...
exec(Tpl, Ctx, Expected) ->
    Got = beamai_mustache:render_string(Tpl, Ctx, #{}),
